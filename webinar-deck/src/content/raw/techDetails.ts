...
console.log("Bootstrapping AppComponent...");`,
    ...
    whatIsIt: "A complete, opinionated framework for building web applications, maintained by Google. Routing, forms, and dependency injection come built in — structure a large team doesn't have to invent.",
...
`console.log("Hello from Svelte!");`,
    ...
    whatIsIt: "A compiler, not a runtime framework. Svelte compiles your components into small, plain JavaScript at build time — less code to download and run.",
...
`console.log("Hello from Next.js!");`,
    ...
    whatIsIt: "A React framework adding server-side rendering, file-based routing, and API routes — fast, SEO-friendly pages with no extra configuration.",
...
`public class Hello {\n    public static void main(String[] args) {\n        System.out.println("Hello from Java!");\n    }\n}`,
    ...
    whatIsIt: "A statically-typed, object-oriented language paired with Spring — enterprise web apps, REST APIs, and microservices, with strong tooling and long-term support.",
...
`Console.WriteLine("Hello from C#!");`,
    ...
    whatIsIt: "Microsoft's statically-typed language, paired with the .NET runtime — similar strengths to Java, with deep integration into Windows and Azure.",
...
`print("Hello from Python!")\nprint("This is really running, via Pyodide.")`,
    ...
    whatIsIt: "A readable, high-level language paired with Django — a batteries-included framework with an admin panel, ORM, and authentication built in.",
...
`console.log("Hello from Node!");\nconsole.log("This is really running, right in your browser.");`,
    ...
    whatIsIt: "JavaScript running on the server, not the browser. TypeScript adds static types on top, catching errors before code even runs — one language, frontend and backend.",
...
`<?php\necho "Hello from PHP!";\n?>`,
    ...
    whatIsIt: "A scripting language built for the web, paired with Laravel — clean routing, an ORM, and templating on top of plain PHP.",
...
`class BillingController extends Controller {
  ...
  postgresql: {
    ...
    whatIsIt: "An open-source relational database with strict tables and enforced relationships — transactions are always fully completed or fully rolled back.",
...
<span class="code-placeholder">-- TODO: replace with your real billing-system queries</span>`
  ...
  mssql: {
    ...
    whatIsIt: "Microsoft's enterprise relational database, tightly integrated with .NET and Windows Server — often bundled into enterprise licensing deals.",
...
<span class="code-placeholder">-- TODO: replace with your real billing-system queries</span>`
  ...
  oracle: {
    ...
    whatIsIt: "A high-end relational database built for the largest enterprise workloads — banking, telecom, airlines — with decades of tooling for reliability at scale.",
...
<span class="code-placeholder">-- TODO: replace with your real billing-system queries</span>`
  ...
  mongodb: {
    ...
    whatIsIt: "A document database storing flexible, JSON-like records instead of rigid tables — a record's shape can change without redesigning a schema.",
